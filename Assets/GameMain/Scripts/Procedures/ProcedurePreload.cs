...
namespace Project
{
    public class ProcedurePreload : ProcedureBase
    {
        ...
        private void Test(Dictionary<int, string> temp, KeyValuePair<int, string> b) {
            if (b.Key == 2)
            {
                temp.Remove(2);
            }
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            //GameFramework.DataTable.IDataTable<DRTest2> dRTest2 = GameEntry.DataTable.GetDataTable<DRTest2>();

            //DRTest2 a = dRTest2.GetDataRow(20);
